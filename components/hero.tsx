      ...
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="order-2 lg:order-1 space-y-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl 2xl:text-8xl font-semibold tracking-tight leading-tight">
              {t({ es: "¡Hola! Soy Felipe", en: "Hello! I'm Felipe" })}
            </h1>
            <p className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl 2xl:text-5xl font-light tracking-wide leading-relaxed">
              {t({ es: "Arquitecto & Especialista en BIM", en: "Architect & BIM Specialist" })}
            </p>
            <p className="text-lg sm:text-xl md:text-xl lg:text-2xl 2xl:text-3xl leading-relaxed text-muted-foreground max-w-2xl">
              {t({
          ...
          <div className="order-1 lg:order-2 flex items-start justify-center lg:justify-end lg:pr-8 py-4 lg:py-6">
            <div className="relative w-full max-w-[26.6rem] lg:max-w-md 2xl:max-w-[36rem] h-auto transition-all duration-700 hover:scale-[1.02] group">
