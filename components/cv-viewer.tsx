            ...
            <div className="space-y-6">
              {cvContent.workExperience.positions.map((position, index) => (
                <div key={index}>
                  ...
                  <p className="text-gray-600 mb-2">{position.company} | {t(position.location)}</p>
              ...
              <div className="space-y-2">
                {cvContent.languages.list.map((lang, index) => (
                  <div key={index} className="flex justify-between items-center">
                    ...
                    <span className="text-sm text-gray-600">{typeof lang.level === 'string' ? lang.level : t(lang.level)}</span>
                  </div>
                ))}
              </div>
            </section>
